This is a merge of [Matterport's Mask R-CNN implementation](https://github.com/matterport/Mask_RCNN) and [FlashTek's Faster Training of Mask R-CNN by Focusing on Instance Boundaries](https://github.com/FlashTek/mask-rcnn-edge-agreement-loss) to ensure the latest of all implementations and preserve git history.
...
![Instance Mask Visualizations](assets/instance_mask_visualizations.jpg)
...
![Architecture](assets/edge_agreement_head_small.png)
...
![Loss Curves](assets/mask_loss.jpg)
